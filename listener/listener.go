...
type NtfyMessageType struct {
	...
	Priority   int             `json:"priority"`             // https://icon-icons.com/pack/essential-ui-outline-gradient/5322 (https://icon-icons.com/authors/1533-sonny-candra)
...
func (l *ListenerType) Start(ctx context.Context, msgChan chan<- NtfyMessageType) error {
	...
	for {
		...
		// 1. Создаем переменную для статистики
